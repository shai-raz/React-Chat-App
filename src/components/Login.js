        ...
        <div id="logreg-forms">
            <form className={`form-signin`}>
                ...
                {/*<div className={`social-login`}>
                    <button className={`btn facebook-btn social-btn`} type="button" disabled={true}>
                        <span><i className={`fab fa-facebook-f`}></i> Sign in with Facebook</span>
                    </button>
                    <button className={`btn google-btn social-btn`} type="button" disabled={true}>
                        <span><i className={`fab fa-google-plus-g`}></i> Sign in with Google</span>
                    </button>
                </div>
                <p> OR  </p>*/}
                ...
                <button className={`btn btn-success btn-block`} type="submit" onClick={signIn}>
                    <i className={`fas fa-sign-in-alt`}></i> Sign in
                </button>
                <a href="#" id="forgot_pswd">Forgot password?</a>
                <hr />
                <button className={`btn btn-primary btn-block`} type="button" id="btn-signup" onClick={props.switchLogin}><i className={`fas fa-user-plus`}></i> Sign up New Account</button>
            </form>
